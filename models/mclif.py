...
class MCLIF(Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.thr_d = cfg.get('thr_d', 1.0)
        self.tau_d_range = cfg.get('tau_d_range', (0.5, 0.5))
        self.tau_p = cfg.get('tau_p', 0.5)
        ...
        self.tau_d_trainer: TauTrainer = get_tau_trainer_class(self.train_tau)(
            self.out_features,
            self.dt,
            self.tau_d_range[0],
            self.tau_d_range[1],
