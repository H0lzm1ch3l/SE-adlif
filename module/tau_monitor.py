...
class TauMonitor(pl.Callback):
    def on_train_epoch_end(self, trainer, pl_module):
        ...
        # Handle MLPSNN structure (l1, l2 attributes)
        if hasattr(pl_module, "l1"):
            for tau in taus:
        ...
        # Handle SpikingResNet structure (no l1/l2 attributes)
        # ResNet logging could be added here if needed